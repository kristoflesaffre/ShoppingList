...
const ITEMS: RawItem[] = [
  ...
  { slug: "airtag", name: "Airtag", section: "Noë", category: "Elektronica", households: ["jongens", "meisjes"] },
  ...
  { slug: "rijstwafels", name: "Rijstwafels", section: "Samen", category: "Eten & drinken" },
